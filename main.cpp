...
const std::vector<Vertex> cubemapVertices = {
...
private:
	...
	std::vector<VkBuffer> postProcessingniformBuffers;
	...
	std::vector<VkDeviceMemory> postProcessingUniformBuffersMemory;
	...
	std::vector<void*> postProcessingUniformBuffersMapped;
